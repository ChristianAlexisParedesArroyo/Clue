...
# Imprimimos la solución (para propósitos de prueba)
...
# Imprimir las asignaciones de cada habitación
for lugar, asignacion in asignaciones.items():
    print(f"En la habitación {lugar} se encuentra {asignacion['persona']} con un/a {asignacion['arma']}.")

print(asignaciones)

# Creamos un ciclo que permita al usuario hacer sus deducciones
for i in range(5): # El usuario tendrá 5 oportunidades para pedir una pista
